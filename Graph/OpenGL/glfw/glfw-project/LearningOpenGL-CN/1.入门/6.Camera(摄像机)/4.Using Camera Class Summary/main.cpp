...
#pragma endregion
    ...
    //*****绑定纹理
    //texture0
    texture0 = LoadImageToGPU("res//container.jpg", GL_RGB, GL_RGB, 0);
    //texture1
    texture1 = LoadImageToGPU("res//tes.jpg", GL_RGB, GL_RGB, 1);
...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            glUniform3f(glGetUniformLocation(ourShader.ID, "ambientLightingColor"), 0.0f, 1.0f, 0.0f);
