...
#pragma endregion
    ...
    //*****绑定纹理
    //texture0
    texture0 = LoadImageToGPU("res//jpg//texture.jpg", GL_RGB, GL_RGB, 0);
    //texture1
    texture1 = LoadImageToGPU("res//jpg//smiling-face.jpg", GL_RGB, GL_RGB, 1);
...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            glUniform3f(glGetUniformLocation(ourShader.ID, "lightColor"), 0.0f, 0.5f, 0.0f);
