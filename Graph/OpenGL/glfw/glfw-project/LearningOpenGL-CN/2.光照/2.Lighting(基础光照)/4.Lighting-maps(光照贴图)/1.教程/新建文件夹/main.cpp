...
#pragma endregion
    ...
    //shader class
    Shader ourShader("vertexshader.vert", "frameshader.frag");
#pragma endregion
    ...
    Material* myMaterial = new Material(&ourShader,
        ...
        glm::vec3(1.0f, 1.0f, 1.0f),
        //LoadImageToGPU("res//png//container2.png", GL_RGBA, GL_RGBA, 0),
...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        Camera ca(glm::vec3(0.0f, 20.0f, 20.0f), glm::vec3(0.0f, 1.0f, 0.0f), 0.0f, 0.0f);
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            glUniform3f(glGetUniformLocation(ourShader.ID, "ambientColor"), 0.5f, 0.1f, 0.1f);
            //glUniform3f(glGetUniformLocation(ourShader.ID, "lightPos"), 10.0f, 10.f, -5.0f);
            glUniform3f(glGetUniformLocation(ourShader.ID, "lightPos"), lx, ly, lz);
            ...
            glUniform3f(glGetUniformLocation(ourShader.ID, "light.ambient"), 1.0f, 1.0f, 1.0f);
            glUniform3f(glGetUniformLocation(ourShader.ID, "light.diffuse"), 1.0f, 1.0f, 1.0f);
            glUniform3f(glGetUniformLocation(ourShader.ID, "light.specular"), 1.0f, 1.0f, 1.0f);
            glUniform1f(glGetUniformLocation(ourShader.ID, "light.shininess"), 1.0f);
            ...
            //myMaterial->shader->setInt("material.diffuse", myMaterial->diffuse);
