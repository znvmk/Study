...
#pragma region Material
    Material* myMaterial = new Material(&ourShader,
         LoadImageToGPU("res//png//container2.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
        LoadImageToGPU("res//png//texture.png", GL_RGBA, GL_RGBA, Shader::SPECULAR),
        LoadImageToGPU("res//png//container2_specular.png", GL_RGBA, GL_RGBA,Shader::EMISSION),
        16.0f);
#pragma endregion
