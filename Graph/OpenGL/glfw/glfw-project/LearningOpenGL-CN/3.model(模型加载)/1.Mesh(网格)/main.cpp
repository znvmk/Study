...
#pragma region Init LightSource
    ParallelLight* dirLight = new ParallelLight(&ourShader, glm::vec3(-0.0f, 5.0f, -0.3f), glm::vec3(glm::radians(90.0f), 0, 0));
    PointLight* pLight0 = new PointLight(&ourShader, pointLightPositions[0], glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    PointLight* pLight1 = new PointLight(&ourShader, pointLightPositions[1], glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    PointLight* pLight2 = new PointLight(&ourShader, pointLightPositions[2], glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    PointLight* pLight3 = new PointLight(&ourShader, pointLightPositions[3], glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 1.0f));
