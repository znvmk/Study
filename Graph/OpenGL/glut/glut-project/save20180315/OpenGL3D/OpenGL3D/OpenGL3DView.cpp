...
BOOL COpenGL3DView::PreCreateWindow(CREATESTRUCT& cs)
{
	...
	cs.cx = m_oglo.m_WindowWidth;
	cs.cy = m_oglo.m_WindowHeight;
...
void COpenGL3DView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
...
void COpenGL3DView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	case VK_UP:AfxMessageBox(_T("键盘up"));break;
	case VK_LEFT:AfxMessageBox(_T("键盘left"));break;
	}
	UpdateData();
