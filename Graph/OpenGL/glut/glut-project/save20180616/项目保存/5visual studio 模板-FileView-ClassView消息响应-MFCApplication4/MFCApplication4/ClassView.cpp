...
BEGIN_MESSAGE_MAP(CClassView, CDockablePane)
	...
	ON_NOTIFY(TVN_SELCHANGED , 2 , &CClassView::OnTvnSelchangedClassViewTree)
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("管网"), 0, 0);
	m_wndClassView.SetItemState(hRoot, TVIS_BOLD, TVIS_BOLD);

	HTREEITEM hClass = m_wndClassView.InsertItem(_T("第一层"), 1, 1, hRoot);
	m_wndClassView.InsertItem(_T("校门") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("理学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("国外语学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("图书馆") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("兵器博物馆") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("信息院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("综合楼") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("琴湖") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("艺帆馆") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("超市") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("食堂") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("学生宿舍") , 3 , 3 , hClass);

	hClass = m_wndClassView.InsertItem(_T("第二层") , 1 , 1 , hRoot);
	m_wndClassView.InsertItem(_T("校门") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("理学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("国外语学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("图书馆") , 3 , 3 , hClass);
	...
	hClass = m_wndClassView.InsertItem(_T("第三层") , 1 , 1 , hRoot);
	m_wndClassView.InsertItem(_T("校门") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("理学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("国外语学院") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("图书馆") , 3 , 3 , hClass);
...
void CClassView::OnTvnSelchangedClassViewTree(NMHDR *pNMHDR , LRESULT *pResult)
{
