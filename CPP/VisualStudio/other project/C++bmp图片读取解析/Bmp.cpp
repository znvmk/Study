...
//显示位图文件头信息
void BMP::showBmpHead(BITMAPFILEHEADER pBmpHead) {
	cout << "位图文件头:" << endl;
...
void BMP::showBmpInforHead(tagBITMAPINFOHEADER pBmpInforHead) {
	cout << "位图信息头:" << endl;
...
int BMP::fileReadInBMPFormat()
{
	...
	if (fpi != NULL)
	{
		...
		for (unsigned int nCounti = 0; nCounti < strInfo.biClrUsed; nCounti++)
		{
			...
			cout << "bmp.strPla[nCounti].rgbBlue" << strPla[nCounti].rgbBlue << endl;
			cout << "bmp.strPla[nCounti].rgbGreen" << strPla[nCounti].rgbGreen << endl;
			cout << "bmp.strPla[nCounti].rgbRed" << strPla[nCounti].rgbRed << endl;
		}
