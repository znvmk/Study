...
应用程序向导已为您创建了此 GO 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
GODlg.h、GODlg.cpp - 对话框
    这些文件包含 CGODlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 GO.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
