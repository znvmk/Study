...
int DrawGLScene(GLvoid)
{
	glClearColor(0.0f, 0.0f, 0.5f, 1.0f);   // 蓝色背景  
...
void play()
{
	...
	glColor3f(1.0f, 0.0f, 0.0f);m_gp.Point();		//画点
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0, 4, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(0.0f, 1.0f, 0.0f);m_gp.Line();		//画线
	glPopMatrix();
	glPushMatrix();
	glTranslatef(5, 4, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(0.0f, 0.0f, 1.0f);m_gp.Triangle();	//画面
	glPopMatrix();
	glPushMatrix();
	glTranslatef(-5, 0, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(1.0f, 1.0f, 0.0f);m_gp.Square();		//画正方面
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0, 0, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(0.0f, 1.0f, 1.0f);m_gp.Esquare();		//画正方体
	glPopMatrix();
	glPushMatrix();
	glTranslatef(5, 0, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(1.0f, 0.0f, 1.0f);m_gp.Park();		//画园
	glPopMatrix();
	glPushMatrix();
	glTranslatef(-5, -4, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
	glColor3f(1.0f, 1.0f, 1.0f);m_gp.Pillar();		//园柱
	glPopMatrix();
	glPushMatrix();
	glTranslatef(0, -4, -13);glRotatef(r, 1.0, 1.0, 1.0); //整体旋转
