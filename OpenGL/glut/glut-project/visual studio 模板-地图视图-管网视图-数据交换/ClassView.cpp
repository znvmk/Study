...
void CClassView::FillClassView()
{
	...
	m_wndClassView.InsertItem(_T("1") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("2") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("3") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("4") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("5") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("6") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("7") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("8") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("9") , 3 , 3 , hClass);
	m_wndClassView.InsertItem(_T("10") , 3 , 3 , hClass);
