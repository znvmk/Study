...
void COpenGLBaseView::OnTimer(UINT_PTR nIDEvent)
{
	...
	//if (nIDEvent == 1)
	{
		//m_oglf.m_fAngleY += 10.0f;
		//m_oglf.m_fAngleX += 1.0f;
		//m_oglf.m_fAngleZ += 5.0f;
	}
...
void COpenGLBaseView::OnKeyDown(UINT nChar , UINT nRepCnt , UINT nFlags)
{
	...
	//case VK_UP: m_oglf.a++;break;
	case VK_UP: MessageBox(_T("keyup"));break;
	case VK_DOWN:m_oglf.a--;break;
	case VK_LEFT:m_oglf.b++;MessageBox(_T("keyleft"));break;
	case VK_RIGHT:m_oglf.b--;break;
	}
	UpdateData();
