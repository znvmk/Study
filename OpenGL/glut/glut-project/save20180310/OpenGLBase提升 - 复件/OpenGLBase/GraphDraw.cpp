...
void  CGraphDraw::DrawTraingleStrip()
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(1.0f);
...
void  CGraphDraw::DrawTraingleFun()
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(1.0f);
...
void CGraphDraw::DrawQuadrilateral()
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(1.0f);
...
void CGraphDraw::DrawQuadrilateralStrip()
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(1.0f);
...
void CGraphDraw::DrawCube(GLdouble GLdLength)
{
...
/*车厢*/
void CGraphDraw::Quadrangle(GLdouble dQuadWidth, GLdouble dQuadHeight)
{
...
/*轮子*/
void CGraphDraw::Wheel(GLdouble dWheelRadius)
{
...
/*卡车*/
void CGraphDraw::PfmMatrixStack()
{
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glLineWidth(1.5f);
	glColor3f(0.2f, 0.5f, 1.0f);
...
void CGraphDraw::DrawSmoothCube()
{
...
void CGraphDraw::AutoMipmapping()
{
	int i, j;
...
GLint CGraphDraw::Sphere(GLdouble radius)
{
...
void CGraphDraw::DrawBezierCurve()
{
...
void CGraphDraw::EvenBezierCurve()
{
	glColor3f(0.0f, 1.0f, 0.0f);
	/*控制点*/
	GLfloat controlPoints[9][3] = {
...
void CGraphDraw::DrawBezier()
{
	DrawBezierCurve();
	EvenBezierCurve();
}

void CGraphDraw::DrawNurbsCurve()
{
	/*控制点*/
...
void CGraphDraw::BzrSufacMeshFill()
{
	/*几何控制点*/
	GLfloat controlPoints[4][4][3] = {
		{ { -0.8f,-0.6f,0.8f },{ -0.2f,-0.6f,1.6f },{ 0.2f,-0.6f,-0.4f },{ 0.6f,-0.6f,0.8f } },
...
void CGraphDraw::NurbsSurfaceTrim()
{
